...
const Header = () => {
  return (
    <div>
<nav className='flex justify-between py-1 px-8 shadow-2xl fixed w-full bg-white z-20 items-center'>
    ...
    <div className='w-[40%] flex justify-between'>
        ...
        <div className='hover:text-sky-500 text-lg  hover:underline'><a href="#about-section">About</a></div>
